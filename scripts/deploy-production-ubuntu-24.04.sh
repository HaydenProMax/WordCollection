...
CONFIG_FILE="${CONFIG_FILE:-/etc/word-collection.env}"

if [[ ! -f "${CONFIG_FILE}" ]]; then
  echo "Missing production config file: ${CONFIG_FILE}"
...
export APP_NAME="word-collection"
export APP_USER="word-collection"
export APP_HOME="/opt/word-collection"
export APP_PORT="8000"
export APP_REF="${APP_REF:-v1.0.0}"
export DB_NAME="word_collection"
export DB_USER="word_collection"
